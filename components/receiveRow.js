...
export default class receiveRow extends Component {
  ...
  render() {
    ...
    const {uuid,id,name,timestamp,from} = this.props
    ...
    return (
      <Row>
          ...
          <Cell style={{borderRight: "1px solid gray", borderBotton: "1px solid gray"}}>{from}</Cell>
      </Row>
    )
  }
}
